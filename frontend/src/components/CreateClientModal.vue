    ...
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <div class="uk-margin">
          ...
          <div class="uk-form-controls">
            <select class="uk-select" id="dns-servers" v-model="form.dns" :disabled="loading">
              ...
              <option value="94.140.14.14, 94.140.15.15">AdGuard DNS (94.140.14.14, 94.140.15.15)</option>
            </select>
          </div>
        </div>
      ...
      <div v-if="createdClient" class="uk-margin-top uk-padding uk-background-muted">
        ...
        <div class="uk-text-center uk-margin">
          <img :src="createdClient.qr_code" alt="QR Code" class="uk-border-rounded" style="max-width: 200px;">
